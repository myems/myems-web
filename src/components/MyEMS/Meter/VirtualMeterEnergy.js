...
const VirtualMeterEnergy = () => {
  ...
  return (
    <Fragment>
      <div>
        <Breadcrumb>
          <BreadcrumbItem>计量表数据</BreadcrumbItem><BreadcrumbItem active>虚拟表能耗分析</BreadcrumbItem>
        </Breadcrumb>
      </div>
          ...
          <Row form>
            ...
            <Col xs="auto">
              <FormGroup>
                ...
                <CustomInput type="select" id="计量表" name="virtualMeter" value={virtualMeter} onChange={({ target }) => setVirtualMeter(target.value)}
                >
...
export default VirtualMeterEnergy;
