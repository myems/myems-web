  ...
  return (
    <Fragment>
          ...
          <Row form>
            ...
            <Col xs="auto">
              <FormGroup>
                ...
                <CustomInput type="select" id="虚拟表" name="virtualMeter" value={virtualMeter} onChange={({ target }) => setVirtualMeter(target.value)}
                >
      ...
      <div className="card-deck">
        <CardSummary rate="-0.23%" title="报告期总成本 (RBM)" color="success" footnote="" footvalue="" footunit="" >
