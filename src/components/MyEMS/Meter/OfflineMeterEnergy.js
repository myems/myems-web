...
const OfflineMeterEnergy = ({t}) => {
  ...
  return (
    <Fragment>
      <div>
        <Breadcrumb>
          <BreadcrumbItem>计量表数据</BreadcrumbItem><BreadcrumbItem active>离线表能耗分析</BreadcrumbItem>
        </Breadcrumb>
      </div>
...
export default withTranslation()(OfflineMeterEnergy);
