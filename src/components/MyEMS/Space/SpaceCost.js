  ...
  return (
    <Fragment>
      ...
      <div className="card-deck">
        <CardSummary rate="-0.23%" title="报告期总电费 (RMB)" color="success" footnote={t('Per Unit Area')} footvalue={5890863/1000} footunit="(RMB/M2)" >
          <CountUp end={5890863} duration={2} prefix="" separator="," decimals={2} decimal="." />
        </CardSummary>
        <CardSummary rate="0.0%" title="报告期总自来水费 (RMB)" color="info" footnote={t('Per Unit Area')} footvalue={29878/1000} footunit="(RMB/M2)">
          <CountUp end={29878} duration={2} prefix="" separator="," decimals={2} decimal="." />
        </CardSummary>
        <CardSummary rate="0.0%" title="报告期总天然气费 (RMB)" color="info" footnote={t('Per Unit Area')} footvalue={9887/1000} footunit="(RMB/M2)">
