...
const CombinedEquipmentStatistics = ({t}) => {
  // State
  ...
  return (
    <Fragment>
      <div>
        <Breadcrumb>
          <BreadcrumbItem>组合设备数据</BreadcrumbItem><BreadcrumbItem active>组合设备统计分析</BreadcrumbItem>
        </Breadcrumb>
      </div>
...
export default withTranslation()(CombinedEquipmentStatistics);
