...
const CombinedEquipmentCost = ({ t }) => {
  ...
  return (
    <Fragment>
      <div>
        <Breadcrumb>
          <BreadcrumbItem>组合设备数据</BreadcrumbItem><BreadcrumbItem active>组合设备成本分析</BreadcrumbItem>
        </Breadcrumb>
      </div>
...
export default withTranslation()(CombinedEquipmentCost);
