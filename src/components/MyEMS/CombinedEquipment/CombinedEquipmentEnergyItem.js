...
const CombinedEquipmentEnergyItem = () => {
  // State
  ...
  return (
    <Fragment>
      <div>
        <Breadcrumb>
          <BreadcrumbItem>组合设备数据</BreadcrumbItem><BreadcrumbItem active>组合设备能耗分项分析</BreadcrumbItem>
        </Breadcrumb>
      </div>
...
export default CombinedEquipmentEnergyItem;
