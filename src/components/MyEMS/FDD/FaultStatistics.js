...
const FaultStatistics = ({ setRedirect, setRedirectUrl, t }) => {
  ...
  return (
    <Fragment>
      <div>
        <Breadcrumb>
          <BreadcrumbItem>{t('Fault Detection & Diagnostics')}</BreadcrumbItem><BreadcrumbItem active>{t('Fault Statistics')}</BreadcrumbItem>
        </Breadcrumb>
      </div>
...
export default withTranslation()(withRedirect(FaultStatistics));
