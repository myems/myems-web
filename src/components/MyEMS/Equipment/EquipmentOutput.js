...
const EquipmentOutput = () => {
  ...
  return (
    <Fragment>
      <div>
        <Breadcrumb>
          <BreadcrumbItem>设备数据分析</BreadcrumbItem><BreadcrumbItem active>设备产出分析</BreadcrumbItem>
        </Breadcrumb>
      </div>
      ...
      <div className="card-deck">
        <CardSummary rate="-0.23%" title="报告期总冷量 (kWh)" color="success" linkText="详情" to="/space/output" >
          <CountUp end={5890863} duration={2} prefix="" separator="," decimals={3} decimal="." />
        </CardSummary>
        <CardSummary rate="0.0%" title="报告期总热量 (GJ)" color="info" linkText="详情" to="/space/output">
          <CountUp end={29878} duration={2} prefix="" separator="," decimals={3} decimal="." />
        </CardSummary>
        <CardSummary rate="0.0%" title="报告期总蒸汽量 (T)" color="info" linkText="详情" to="/space/output">
