...
const EquipmentEnergyCategory = ({t}) => {
  // State
  ...
  return (
    <Fragment>
      <div>
        <Breadcrumb>
          <BreadcrumbItem>{t('Equipment Data')}</BreadcrumbItem><BreadcrumbItem active>{t('Energy Category')}</BreadcrumbItem>
        </Breadcrumb>
      </div>
      ...
      <div className="card-deck">
        ...
        <CardSummary rate="0.0%" title="报告期自来水量 (M3)" color="info" footnote="" footvalue="" footunit="">
          <CountUp end={29878} duration={2} prefix="" separator="," decimals={2} decimal="." />
        </CardSummary>
        <CardSummary rate="0.0%" title="报告期天然气量 (M3)" color="info" footnote="" footvalue="" footunit="">
...
export default withTranslation()(EquipmentEnergyCategory);
