...
const resources = {
  ...
  de: {
    translation: {
      ...
      "Meter Realtime": "Messgeräts Echtzeit",
      "Virtual Meter Energy": "Virtuelles Messgerät Energie",
      "Virtual Meter Cost": "Virtuelles Messgerät Kosten",
      "Offline Meter Energy": "Offline Messgerät Energie",
      "Offline Meter Cost": "Offline Messgerät Kosten",
      "Meter Tracking": "Messgerätverfolgung",
      ...
      "Reporting Period Cumulative Efficiency UNIT": "Berichtszeitraum Kumulative Effizienz {{UNIT}}",
      ...
      "Reporting Period CATEGORY Average Load VALUE UNIT": "Berichtszeitraum {{CATEGORY}} Durchschnittliche Belastung {{VALUE}} {{UNIT}}",
      "Base Period CATEGORY Average Load VALUE UNIT": "Basiszeitraum {{CATEGORY}} Durchschnittliche Belastung {{VALUE}} {{UNIT}}",
      "Reporting Period CATEGORY Maximum Value UNIT": "Berichtszeitraum {{CATEGORY}} Höchster Wert {{UNIT}}",
      "Reporting Period CATEGORY Minimum Value UNIT": "Berichtszeitraum {{CATEGORY}} Mindestwert {{UNIT}}",
      "Reporting Period CATEGORY Average Value UNIT": "Berichtszeitraum {{CATEGORY}} Durchschnittswert {{UNIT}}",
      ...
      "Reporting Period Lost CATEGORY UNIT": "Berichtszeitraum verloren {{CATEGORY}}量 {{UNIT}}",
