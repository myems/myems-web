...
const resources = {
  en: {
    translation: {
      ...
      "Reporting Period CATEGORY Costs UNIT": "Reporting Period {{CATEGORY}} Costs {{UNIT}}",
      "Reporting Period CATEGORY Costs VALUE UNIT": "Reporting Period {{CATEGORY}} Costs {{VALUE}} {{UNIT}}",
      "Base Period CATEGORY Costs VALUE UNIT": "Base Period {{CATEGORY}} Costs {{VALUE}} {{UNIT}}",
  ...
  zh_cn: {
    translation: {
      ...
      "Reporting Period CATEGORY Costs UNIT": "报告期 {{CATEGORY}} 费 {{UNIT}}",
      "Reporting Period CATEGORY Costs VALUE UNIT": "报告期 {{CATEGORY}} 费 {{VALUE}} {{UNIT}}",
      "Base Period CATEGORY Costs VALUE UNIT": "基准期 {{CATEGORY}} 费 {{VALUE}} {{UNIT}}",
